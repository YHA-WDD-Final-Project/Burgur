        ...
        <?php
            ...
            <div class="card" style="width: 200px; margin-top: 100px;">
                ...
                <form action="" method="post" style="text-align:center; border:none;">
                    ...
                    <input disabled type="text" name="actname" value="<?php echo $row['item_name'];?>">
                    <input disabled type="text" name="actprice" value="<?php echo $row['item_price'];?>Kyats">
                    <input disabled type="text" name="actcat" value="<?php echo $row['c_name'];?>">
